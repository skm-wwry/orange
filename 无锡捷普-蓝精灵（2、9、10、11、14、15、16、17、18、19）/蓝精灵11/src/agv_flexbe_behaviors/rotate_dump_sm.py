...
class rotate_dumpSM(Behavior):
	...
	def __init__(self):
		super(rotate_dumpSM, self).__init__()
		self.name = 'rotate_dump'
	...
	def create(self):
		...
		with _state_machine:
			# x:203 y:41
			OperatableStateMachine.add('rotate_dump_pos',
										string_pub(topic="drive_request", data="rotate_dump_pos"),
			...
			OperatableStateMachine.add('rotate_state_response',
										...
										transitions={'done': 'finished', 'failed': 'rotate_dump_pos'},
