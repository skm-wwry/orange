	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('blkc01l2Dwon',
										Navigation(position_x=44.421, position_y=173.94, position_z=0, orientation_x=0, orientation_y=0, orientation_z=-0.7071, orientation_w=0.7071, frame_id='map'),
			...
			OperatableStateMachine.add('do_forward_60',
										HomingControl(target_frame="base_link", target_x=0.6, target_y=0, target_yaw=0),
										transitions={'succeeded': 'playblkc01l2', 'failed': 'log5'},
										autonomy={'succeeded': Autonomy.Off, 'failed': Autonomy.Off})
			...
			OperatableStateMachine.add('log3',
										LogState(text="blkc01l2 canceled", severity=Logger.REPORT_HINT),
			...
			# x:288 y:605
			OperatableStateMachine.add('playblkc01l2',
			...
			# x:665 y:606
			OperatableStateMachine.add('stopblkc01l2',
										AlertLoopStop(),
			...
			OperatableStateMachine.add('wait30s',
										...
										transitions={'done': 'stopblkc01l2'},
										autonomy={'done': Autonomy.Off})

			# x:840 y:318
			OperatableStateMachine.add('beginDown',
										Navigation(position_x=82.260, position_y=18.461, position_z=0, orientation_x=0, orientation_y=0, orientation_z=1, orientation_w=0, frame_id='map'),
