	...
	def create(self):
		...
		with _sm_pile_0:
			...
			OperatableStateMachine.add('charge-homing',
										...
										transitions={'succeeded': 'pile_off', 'failed': 'log-homing'},
		...
		with _state_machine:
			...
			OperatableStateMachine.add('charge_point',
										Navigation(position_x=82.310, position_y=17.923, position_z=0, orientation_x=0, orientation_y=0, orientation_z=-0.7071, orientation_w=0.7071, frame_id='map'),
