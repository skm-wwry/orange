	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('lift_load',
										...
										transitions={'finished': 'blkc05l3Dwon'},
										autonomy={'finished': Autonomy.Inherit})
			...
			OperatableStateMachine.add('playblkc01l1',
										AlertPlay(sound_id=56, mode="loop", wait_time=5, single_time=3),
			...
			# x:696 y:24
			OperatableStateMachine.add('blkc05l3Dwon',
										SiteNavigation(site_name="blkc05l3Dwon"),
