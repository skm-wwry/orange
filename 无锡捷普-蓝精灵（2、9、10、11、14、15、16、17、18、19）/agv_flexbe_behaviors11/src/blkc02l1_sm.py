	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('blkc02up',
										SiteNavigation(site_name=blkc02up),
			...
			OperatableStateMachine.add('do_forward_60',
										...
										transitions={'succeeded': 'playblkc02l1', 'failed': 'log5'},
										autonomy={'succeeded': Autonomy.Off, 'failed': Autonomy.Off})
			...
			OperatableStateMachine.add('lift_load',
										...
										transitions={'finished': 'blkc02down'},
										autonomy={'finished': Autonomy.Inherit})
			...
			# x:513 y:600
			OperatableStateMachine.add('playblkc02l1',
										AlertPlay(sound_id=57, mode="loop", wait_time=3, single_time=3),
			...
			# x:898 y:597
			OperatableStateMachine.add('stopblkc02l1',
										AlertLoopStop(),
										transitions={'done': 'blkc02up'},
										autonomy={'done': Autonomy.Off})
			...
			OperatableStateMachine.add('wait30s',
										...
										transitions={'done': 'stopblkc02l1'},
										autonomy={'done': Autonomy.Off})

			# x:76 y:299
			OperatableStateMachine.add('blkc02down',
										SiteNavigation(site_name=blkc02down),
