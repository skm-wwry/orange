...
class BLKC03l3SM(Behavior):
	...
	def __init__(self):
		super(BLKC03l3SM, self).__init__()
		self.name = 'BLKC03l3'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('do_forward_60',
										...
										transitions={'succeeded': 'playblkc03l3', 'failed': 'log5'},
										autonomy={'succeeded': Autonomy.Off, 'failed': Autonomy.Off})
			...
			# x:513 y:600
			OperatableStateMachine.add('playblkc03l3',
										AlertPlay(sound_id=65, mode="loop", wait_time=3, single_time=3),
			...
			# x:898 y:597
			OperatableStateMachine.add('stopblkc03l3',
										AlertLoopStop(),
										transitions={'done': 'blkc03up'},
										autonomy={'done': Autonomy.Off})
