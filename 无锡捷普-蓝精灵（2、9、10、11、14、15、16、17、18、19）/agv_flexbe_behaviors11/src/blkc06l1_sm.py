...
class BLKC06l1SM(Behavior):
	...
	def __init__(self):
		super(BLKC06l1SM, self).__init__()
		self.name = 'BLKC06l1'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('do_forward_60',
										...
										transitions={'succeeded': 'playblkc06l1', 'failed': 'log5'},
										autonomy={'succeeded': Autonomy.Off, 'failed': Autonomy.Off})
			...
			# x:513 y:600
			OperatableStateMachine.add('playblkc06l1',
										AlertPlay(sound_id=60, mode="loop", wait_time=3, single_time=3),
			...
			# x:898 y:597
			OperatableStateMachine.add('stopblkc06l1',
										AlertLoopStop(),
										transitions={'done': 'blkc06up'},
										autonomy={'done': Autonomy.Off})
