	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('blkc07up',
										SiteNavigation(site_name=blkc07up),
			...
			OperatableStateMachine.add('do_forward_60',
										...
										transitions={'succeeded': 'playblkc07l2', 'failed': 'log5'},
										autonomy={'succeeded': Autonomy.Off, 'failed': Autonomy.Off})
			...
			OperatableStateMachine.add('lift_load',
										...
										transitions={'finished': 'blkc07down'},
										autonomy={'finished': Autonomy.Inherit})
			...
			OperatableStateMachine.add('log3',
										LogState(text="blkc07down canceled", severity=Logger.REPORT_HINT),
			...
			# x:513 y:600
			OperatableStateMachine.add('playblkc07l2',
										AlertPlay(sound_id=68, mode="loop", wait_time=3, single_time=3),
			...
			# x:898 y:597
			OperatableStateMachine.add('stopblkc07l2',
										AlertLoopStop(),
										transitions={'done': 'blkc07up'},
										autonomy={'done': Autonomy.Off})
			...
			OperatableStateMachine.add('wait30s',
										...
										transitions={'done': 'stopblkc07l2'},
										autonomy={'done': Autonomy.Off})

			# x:76 y:299
			OperatableStateMachine.add('blkc07down',
										SiteNavigation(site_name=blkc07down),
