	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('do_forward_60',
										...
										transitions={'succeeded': 'playblkc02l2', 'failed': 'log5'},
										autonomy={'succeeded': Autonomy.Off, 'failed': Autonomy.Off})
			...
			# x:513 y:600
			OperatableStateMachine.add('playblkc02l2',
										AlertPlay(sound_id=58, mode="loop", wait_time=3, single_time=3),
			...
			# x:898 y:597
			OperatableStateMachine.add('stopblkc02l2',
										AlertLoopStop(),
										transitions={'done': 'blkc02up'},
										autonomy={'done': Autonomy.Off})
