	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('do_forward_60',
										...
										transitions={'succeeded': 'playblkc07l3', 'failed': 'log5'},
										autonomy={'succeeded': Autonomy.Off, 'failed': Autonomy.Off})
			...
			# x:513 y:600
			OperatableStateMachine.add('playblkc07l3',
										AlertPlay(sound_id=69, mode="loop", wait_time=3, single_time=3),
			...
			# x:898 y:597
			OperatableStateMachine.add('stopblkc07l3',
										AlertLoopStop(),
										transitions={'done': 'blkc07up'},
										autonomy={'done': Autonomy.Off})
