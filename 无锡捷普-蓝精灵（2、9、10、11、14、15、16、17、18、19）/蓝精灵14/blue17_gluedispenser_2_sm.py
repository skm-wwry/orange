...
from agv_flexbe_behaviors.wheel_dump_pos_sm import wheel_dump_posSM
...
@author: sunkm
'''
class blue17_glueDispenser_2SM(Behavior):
	'''
	glue dispenser site2
	'''


	def __init__(self):
		super(blue17_glueDispenser_2SM, self).__init__()
		self.name = 'blue17_glueDispenser_2'
		...
		self.add_behavior(wheel_dump_posSM, 'wheel_dump_pos')
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('lift_dump',
										...
										transitions={'finished': 'wheel_dump_pos'},
			...
			# x:275 y:521
			OperatableStateMachine.add('wheel_dump_pos',
										self.use_behavior(wheel_dump_posSM, 'wheel_dump_pos'),
