	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('judge_amcl',
										JudgeAMCL(),
										transitions={'true': 'websocket_tcp', 'false': 'wait1s'},
			...
			# x:496 y:174
			OperatableStateMachine.add('websocket_tcp',
										TaskSwitch(seq=1, frame_id="launch_~/catkin_ws/devel/share/rosbridge_server/launch/rosbridge_websocket.launch"),
										transitions={'done': 'init_lift'},
										autonomy={'done': Autonomy.Off})
