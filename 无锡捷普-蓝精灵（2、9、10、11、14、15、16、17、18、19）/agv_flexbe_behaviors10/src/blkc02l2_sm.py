...
class BLKC02l2SM(Behavior):
	...
	def __init__(self):
		super(BLKC02l2SM, self).__init__()
		self.name = 'BLKC02l2'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('blkc02play',
										AlertPlay(sound_id=58, mode="loop", wait_time=5, single_time=3),
			...
			OperatableStateMachine.add('do_forward_60',
										...
										transitions={'succeeded': 'blkc02play', 'failed': 'log5'},
