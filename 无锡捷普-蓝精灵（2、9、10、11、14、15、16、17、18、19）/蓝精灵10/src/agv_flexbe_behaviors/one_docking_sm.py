	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('one_on',
										OneOn(),
										transitions={'done': 'alert_play_one'},
										autonomy={'done': Autonomy.Off})

			# x:622 y:119
			OperatableStateMachine.add('alert_stop_one',
										AlertLoopStop(),
										transitions={'done': 'one_off'},
										autonomy={'done': Autonomy.Off})
			...
			OperatableStateMachine.add('one_homing',
										...
										transitions={'succeeded': 'alert_stop_one', 'failed': 'homing_resend'},
			...
			# x:49 y:119
			OperatableStateMachine.add('alert_play_one',
