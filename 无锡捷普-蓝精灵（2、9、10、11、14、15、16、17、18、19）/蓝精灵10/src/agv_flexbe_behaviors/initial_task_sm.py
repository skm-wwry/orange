	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('initial-pose',
										InitializationPose(position_x=84.473, position_y=17.418, position_z=0, orientation_x=0, orientation_y=0, orientation_z=0.7071, orientation_w=0.7071, frame_id='map'),
