	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('agv_local_footprint',
										ReconfigureState(client="move_base/local_costmap", parameter="footprint", value='[[0.55, 0.375], [0.55, -0.375], [-0.55, -0.375], [-0.55, 0.375]]'),
			...
			OperatableStateMachine.add('agv_global_footprint',
										ReconfigureState(client="move_base/global_costmap", parameter="footprint", value='[[0.55, 0.375], [0.55, -0.375], [-0.55, -0.375], [-0.55, 0.375]]'),
