	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('lift_load',
										driver(topic='', name='lift_pos', mb_addr='', mb_data=1000, timeoff=1.0, timeout=0.0),
			...
			OperatableStateMachine.add('agv_local_footprint',
										ReconfigureState(client="move_base/local_costmap", parameter="footprint", value='[[0.825, 0.375], [0.825, -0.375], [-0.825, -0.375], [-0.825, 0.375]]'),
			...
			OperatableStateMachine.add('agv_global_footprint',
										ReconfigureState(client="move_base/global_costmap", parameter="footprint", value='[[0.825, 0.375], [0.825, -0.375], [-0.825, -0.375], [-0.825, 0.375]]'),
