...
class autocharge_onSM(Behavior):
	...
	def create(self):
		...
		# x:237 y:241, x:632 y:106, x:88 y:253, x:1430 y:0, x:236 y:306, x:625 y:189
		...
		with _state_machine:
			...
			OperatableStateMachine.add('charge_point',
										SiteNavigation(site_name="charge_point"),
										transitions={'arrived': 'Pile', 'canceled': 'log_1', 'failed': 'log_1'},
			...
			# x:250 y:549
			OperatableStateMachine.add('autochargeplay',
										AlertPlay(sound_id=26, mode="single", wait_time=5, single_time=3),
										transitions={'done': 'finished'},
										autonomy={'done': Autonomy.Off})

			# x:493 y:442
			OperatableStateMachine.add('autochargestop',
										AlertPlay(sound_id=27, mode="single", wait_time=5, single_time=3),
			...
			OperatableStateMachine.add('Container',
										_sm_container_1,
										transitions={'finished': 'autochargeplay', 'failed': 'autochargestop', 'stop': 'autochargeplay'},
