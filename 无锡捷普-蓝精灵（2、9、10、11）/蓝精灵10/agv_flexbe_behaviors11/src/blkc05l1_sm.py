...
class BLKC05l1SM(Behavior):
	...
	def __init__(self):
		super(BLKC05l1SM, self).__init__()
		self.name = 'BLKC05l1'
	...
	def create(self):
		...
		with _state_machine:
			...
			# x:75 y:324
			OperatableStateMachine.add('blkc05l1Dwon',
										Navigation(position_x=37.083, position_y=173.94, position_z=0, orientation_x=0, orientation_y=0, orientation_z=-0.7071, orientation_w=0.7071, frame_id='map'),
			...
			OperatableStateMachine.add('do_forward_60',
										HomingControl(target_frame="base_link", target_x=0.6, target_y=0, target_yaw=0),
										transitions={'succeeded': 'playblkc05l1', 'failed': 'log5'},
										autonomy={'succeeded': Autonomy.Off, 'failed': Autonomy.Off})
			...
			OperatableStateMachine.add('lift_load',
										...
										transitions={'finished': 'blkc05l1Dwon'},
										autonomy={'finished': Autonomy.Inherit})
			...
			OperatableStateMachine.add('log3',
										LogState(text="blkc05l1 canceled", severity=Logger.REPORT_HINT),
										transitions={'done': 'blkc05l1Dwon'},
										autonomy={'done': Autonomy.Off})
			...
			# x:288 y:605
			OperatableStateMachine.add('playblkc05l1',
										AlertPlay(sound_id=54, mode="loop", wait_time=5, single_time=3),
			...
			# x:665 y:606
			OperatableStateMachine.add('stopblkc05l1',
										AlertLoopStop(),
