	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('blkc03up',
										Navigation(position_x=39.884, position_y=89.399, position_z=0, orientation_x=0, orientation_y=0, orientation_z=0.7071, orientation_w=0.7071, frame_id='map'),
										transitions={'arrived': 'playblkc02', 'failed': 'log6', 'canceled': 'log6'},
										autonomy={'arrived': Autonomy.Off, 'failed': Autonomy.Off, 'canceled': Autonomy.Off})

			# x:77 y:297
			OperatableStateMachine.add('blkc04Dwon',
										Navigation(position_x=44.264, position_y=89.765, position_z=0, orientation_x=0, orientation_y=0, orientation_z=1, orientation_w=0, frame_id='map'),
			...
			OperatableStateMachine.add('do_forward_60',
										...
										transitions={'succeeded': 'blkc03up', 'failed': 'log5'},
			...
			# x:731 y:603
			OperatableStateMachine.add('playblkc02',
										AlertPlay(sound_id=57, mode="loop", wait_time=5, single_time=3),
			...
			# x:1099 y:603
			OperatableStateMachine.add('stopblkc02',
										AlertLoopStop(),
