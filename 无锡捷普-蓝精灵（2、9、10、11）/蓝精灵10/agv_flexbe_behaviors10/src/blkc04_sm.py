	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('blkc04up',
										Navigation(position_x=42.017, position_y=88.946, position_z=0, orientation_x=0, orientation_y=0, orientation_z=0.7071, orientation_w=0.7071, frame_id='map'),
			...
			OperatableStateMachine.add('do_forward_60',
										...
										transitions={'succeeded': 'blkc04up', 'failed': 'log3'},
			...
			OperatableStateMachine.add('shelf_docking_2',
										...
										transitions={'finished': 'turnleft5', 'failed': 'home'},
										autonomy={'finished': Autonomy.Inherit, 'failed': Autonomy.Inherit})
			...
			# x:1362 y:413
			OperatableStateMachine.add('turnleft5',
										TurnLeft(),
										transitions={'succeeded': 'lift_load_2', 'failed': 'log_2'},
										autonomy={'succeeded': Autonomy.Off, 'failed': Autonomy.Off})
