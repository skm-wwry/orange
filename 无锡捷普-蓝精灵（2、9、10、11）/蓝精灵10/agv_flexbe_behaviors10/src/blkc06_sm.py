	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('blkc06Dwon',
										Navigation(position_x=38.286, position_y=152.651, position_z=0, orientation_x=0, orientation_y=0, orientation_z=0.7071, orientation_w=0.7071, frame_id='map'),
			...
			OperatableStateMachine.add('do_forward_60',
										...
										transitions={'succeeded': 'blkc06up', 'failed': 'log3'},
