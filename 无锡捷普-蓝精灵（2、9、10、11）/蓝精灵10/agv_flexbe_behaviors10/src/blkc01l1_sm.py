...
class BLKC01l1SM(Behavior):
	...
	def __init__(self):
		super(BLKC01l1SM, self).__init__()
		self.name = 'BLKC01l1'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('blkc01l1Dwon',
										Navigation(position_x=47.113, position_y=173.94, position_z=0, orientation_x=0, orientation_y=0, orientation_z=-0.7071, orientation_w=0.7071, frame_id='map'),
			...
			OperatableStateMachine.add('do_forward_60',
										HomingControl(target_frame="base_link", target_x=0.6, target_y=0, target_yaw=0),
										transitions={'succeeded': 'playblkc01l1', 'failed': 'log5'},
										autonomy={'succeeded': Autonomy.Off, 'failed': Autonomy.Off})
			...
			OperatableStateMachine.add('home',
										Navigation(position_x=84.473, position_y=18.098, position_z=0, orientation_x=0, orientation_y=0, orientation_z=1, orientation_w=0, frame_id='map'),
