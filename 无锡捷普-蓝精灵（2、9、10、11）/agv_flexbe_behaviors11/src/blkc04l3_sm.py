...
class BLKC04l3SM(Behavior):
	...
	def create(self):
		...
		with _state_machine:
			...
			# x:515 y:601
			OperatableStateMachine.add('blkc04play',
										AlertPlay(sound_id=71, mode="loop", wait_time=5, single_time=3),
										transitions={'done': 'wait30s'},
										autonomy={'done': Autonomy.Off})

			# x:900 y:596
			OperatableStateMachine.add('blkc04stop',
										AlertLoopStop(),
			...
			OperatableStateMachine.add('do_forward_60',
										...
										transitions={'succeeded': 'blkc04play', 'failed': 'log5'},
